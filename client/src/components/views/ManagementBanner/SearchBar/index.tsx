...
export const SearchBar = ({ value }: searchBarProps) => {
  return (
    <div className="searchBarContainer">
      <SearchIcon />
      <input type="text" className="searchBarInput" value={value} placeholder="search" />
    </div>
  );
};
